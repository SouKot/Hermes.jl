...
include("test_dirty_tracking.jl")
include("test_direct_snapshot.jl")
include("test_profiling_simd.jl")
include("test_adaptive_threshold.jl")
include("test_scenespec.jl")
include("test_scenespec_typed.jl")
include("test_scenespec_validation.jl")
include("test_scenespec_extensions.jl")
include("test_scenespec_subgraphs.jl")
include("test_scenespec_compiler.jl")
include("test_analytical_benchmarks.jl")
include("test_run_report.jl")
