...
|---|---|---|---|---|---|
| DES-S-01 | M/M/1 ρ=0.5 | Small | P0 | `[ ]` | First test to implement |
| DES-S-02 | M/M/1 ρ=0.9 | Small | P0 | `[ ]` | Near-saturation |
| DES-S-03 | M/M/1 spectrum | Small | P1 | `[ ]` | 7 utilization levels |
| DES-S-04 | M/M/c Erlang-C | Small | P0 | `[ ]` | Multi-server |
| DES-S-05 | M/M/1/K blocking | Small | P1 | `[ ]` | Finite buffer |
| DES-S-06 | M/D/1 deterministic | Small | P1 | `[ ]` | P-K formula |
| DES-S-07 | M/G/1 Erlang service | Small | P2 | `[ ]` | General service |
| DES-S-08 | Event cancellation | Small | P0 | `[ ]` | Core correctness |
| DES-S-09 | SimClock fidelity | Small | P1 | `[ ]` | Speed control |
| DES-M-01 | Tandem queue | Medium | P1 | `[ ]` | Jackson's theorem |
| DES-M-02 | Jackson network 4 nodes | Medium | P2 | `[ ]` | Routing |
| DES-M-03 | Priority queue | Medium | P2 | `[ ]` | Preemptive |
| DES-M-04 | Machine with failures | Medium | P2 | `[ ]` | Breakdowns |
| DES-M-05 | Batch arrivals | Medium | P3 | `[ ]` | Batch events |
| DES-M-06 | Time-varying arrivals | Medium | P2 | `[ ]` | Non-stationary |
| DES-M-07 | Fork-Join | Medium | P3 | `[ ]` | Parallel tasks |
| DES-L-01 | Manufacturing cell | Large | P2 | `[ ]` | 5-machine line |
| DES-L-02 | Call center | Large | P3 | `[ ]` | Realistic |
| DES-L-03 | DC inbound (PDES) | Large | P1 | `[ ]` | Tier 2 test |
| CRW-S-01 | Single agent goal | Small | P0 | `[ ]` | First crowd test |
| CRW-S-02 | Obstacle avoidance | Small | P0 | `[ ]` | |
| CRW-S-03 | Head-on avoidance | Small | P0 | `[ ]` | |
| CRW-S-04 | 10-agent bottleneck | Small | P0 | `[ ]` | Arching |
| CRW-S-05 | Faster-is-slower | Small | P1 | `[ ]` | Panic |
| CRW-M-01 | Lane formation 200 | Medium | P1 | `[ ]` | Helbing 1995 |
| CRW-M-02 | Fundamental diagram | Medium | P1 | `[ ]` | Weidmann 1993 |
| CRW-M-03 | 500-agent multi-exit | Medium | P1 | `[ ]` | |
| CRW-M-04 | T-junction merge | Medium | P2 | `[ ]` | |
| CRW-M-05 | Stadium 2k agents | Medium | P2 | `[ ]` | SFPE |
| CRW-L-01 | 10k venue evac | Large | P1 | `[ ]` | Performance |
| CRW-L-02 | 5k panic scenario | Large | P2 | `[ ]` | |
| CRW-L-03 | Hospital DES+Crowd | Large | P2 | `[ ]` | Integration |
| PAR-01 | Serial vs parallel correctness | Any | P0 | `[ ]` | PDES validation |
| PAR-02 | Null message / deadlock | Small | P0 | `[ ]` | |
| PAR-03 | Speedup vs LP count | Scalability | P1 | `[ ]` | Amdahl's law |
| PAR-04 | FEL throughput scaling | Scalability | P1 | `[ ]` | O(log n) |
| PAR-05 | Crowd agent scaling | Scalability | P1 | `[ ]` | GPU |
